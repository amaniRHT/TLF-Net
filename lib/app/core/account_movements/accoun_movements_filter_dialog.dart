...
class AccountMovementsFilterDialog extends StatefulWidget {
  const AccountMovementsFilterDialog({Key key}) : super(key: key);

  @override
  _RDVsFilterDialogState createState() => _RDVsFilterDialogState();
}

class _RDVsFilterDialogState extends State<AccountMovementsFilterDialog> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: KeyboardDismissOnTap(
        child: GetBuilder<AccountMovementsController>(
          builder: (_) {
            return FilterDialog(
              formKey: _formKey,
